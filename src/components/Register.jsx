...
import { register as registerApi, getRoleIdByCode } from "../services/api";
...
export default function Register() {
  ...
  const handleChange = async (e) => {
    ...
    setFormData((prev) => ({ ...prev, role: fieldValue, roleId: "" }));
    ...
    try {
      const res = await getRoleIdByCode(String(fieldValue).toUpperCase());
  ...
  return (
    <AuthLayout visualHeading="Create your account">
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="login-form-submit" disabled={roleLoading}>
          Create Account
        </button>
